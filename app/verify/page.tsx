...
import { generateAvatarColor, truncateAddress } from '@/lib/utils';
...
function VerifyDashboard() {
  ...
  if (!connected || !wallet) {
    return (
      <div style={{ minHeight: '100vh', paddingTop: '100px', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '100px 24px 40px' }}>
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              fontFamily: 'inherit', transition: 'background 0.12s ease', letterSpacing: '-0.01em',
            }}
    ...
    <>
      <div style={{ maxWidth: '960px', margin: '0 auto', padding: '88px 24px 60px' }}>
        <div style={{ display: 'grid', gridTemplateColumns: '240px 1fr', gap: '24px', alignItems: 'start' }}>
          ...
          <div style={{
            background: 'var(--bg-surface)', border: '1px solid var(--border-subtle)',
            borderRadius: '14px', padding: '20px', position: 'sticky', top: '72px',
          }}>
            {/* Avatar */}
            <div style={{ textAlign: 'center' }}>
              <div style={{
                ...
                justifyContent: 'center', fontSize: '18px', fontWeight: 600, color: '#fff',
                margin: '0 auto 10px',
              }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <a
                ...
                style={{
                  ...
                  height: '38px', borderRadius: '10px', fontSize: '14px', fontWeight: 500,
